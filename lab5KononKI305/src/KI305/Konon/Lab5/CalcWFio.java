...
class CalcWFio
{
    ...
    public void writeResBinRandomAccess(String fName) throws IOException {
    ...
    public void readResBinRandomAccess(String fName) throws IOException {
    ...
    public void writeResTxtRandomAccess(String fName) throws IOException {
        try (RandomAccessFile file = new RandomAccessFile(fName, "rw")) {
            file.seek(file.length());
            file.writeBytes(String.valueOf(result) + " ");
        }
    }
